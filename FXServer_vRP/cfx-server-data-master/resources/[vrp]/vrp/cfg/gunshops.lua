...
cfg.gunshop_types = {
  [""] = {
    ...
    ["WEAPON_BOTTLE"] = {"Garrafa",1000000000,0,""},
    ["WEAPON_BAT"] = {"Taco de beisebol",1000000000,0,""},
    ["WEAPON_KNUCKLE"] = {"Soco-Ingles",1000000000,0,""},
    ["WEAPON_KNIFE"] = {"Faca",1000000000,0,""},
    ["WEAPON_SNSPISTOL"] = {"Pistola Fajuta",1000000000,1000000000,""},
    ["WEAPON_PISTOL"] = {"Pistola",1000000000,1000000000,""},
    ["WEAPON_FLASHLIGHT"] = {"Lanterna",1000000000,0,""},
    ["WEAPON_ASSAULTRIFLE"] = {"Ak-47",1000000000,1000000000,""},
  },
  ["Loja da Biqueira"] = {
    _config = {blipid=110,blipcolor=75},
    ["WEAPON_ASSAULTRIFLE"] = {"Ak-47",1000000000,1000000000,""},
	["WEAPON_COMBATPISTOL"] = {"Pistola de Combate",1000000000,1000000000,""},
  } 
}
